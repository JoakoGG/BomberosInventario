...
class VentanaPrincipal(QMainWindow):
    ...
    print("111")
        ...
        self.table1.horizontalHeader().setDefaultAlignment(
        ...
        self.Agregar2.clicked.connect(
            lambda: (self.agregarRegistro(self.table2, "inventario"))
        )
        ...
        self.lineEditT1.textChanged.connect(
            lambda: (self.buscar(self.table1, self.lineEditT1))
        )
    ...
    def _removeRow(self):
        ...
        if filaSeleccionada:
            ...
            QMessageBox.critical(
                self, "Eliminar fila", "Seleccione una fila.   ", QMessageBox.Ok
            )
